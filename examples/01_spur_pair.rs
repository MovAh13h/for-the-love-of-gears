...
fn main() {
    ...
    row(
        "Reference diameter",
        driver.reference_diameter(),
        driven.reference_diameter(),
        "mm    d = mz",
        w,
    );
    row(
    ...
    row(
        "Root diameter",
        driver.root_diameter(),
        driven.root_diameter(),
        "mm    df = m(z−2.5)",
        w,
    );
    row(
        "Base diameter",
        driver.base_diameter(),
        driven.base_diameter(),
        "mm    db = d·cos α",
        w,
    );
    println!();
    ...
    row(
        "Tooth thickness",
        driver.tooth_thickness(),
        driven.tooth_thickness(),
        "mm    s = πm/2",
        w,
    );
    println!();
    row(
        "Circular pitch",
        driver.circular_pitch(),
        driven.circular_pitch(),
        "mm    p = πm",
        w,
    );
    row(
        "Diametral pitch",
        driver.diametral_pitch(),
        driven.diametral_pitch(),
        "t/in  DP = 25.4/m",
        w,
    );
    ...
    println!(
        ...
        driver.center_distance_to(&driven)
    );
    println!(
        "  Gear ratio        {:>8.3}:1",
    ...
    println!(
        ...
        driver.contact_ratio_with(&driven).unwrap()
    );
}
